      ...
      <>
        <NavbarLayout>
          <div className="flex h-auto w-full flex-col bg-white pb-5">
            <section
                className="flex min-h-96 w-full flex-col items-center justify-center border-2 bg-green-900 text-white shadow-2xl">
            ...
            <section
                className="flex w-full flex-col items-center justify-center gap-10 border-2 bg-orange-50 p-7 pl-48 pr-48">
            ...
            <section
                className="flex w-full flex-row items-center justify-center gap-10 border-2 bg-orange-50 p-20 pl-48 pr-48">
            ...
            <section className="flex w-full flex-col items-center justify-center gap-10 border-2 p-20">
              ...
              <div
                  className="flex w-full flex-row items-center justify-center gap-7 overflow-x-auto p-2 pl-10 pr-10 no-scrollbar">
                <ProviderCard
                    name="Derrick"
                    image=""
                    rate="500"
            ...
            <section
                className="flex w-full flex-row items-center justify-center gap-10 rounded-xl border-2 bg-green-900 p-20">
              <div className="flex flex-col gap-2 self-start">
                ...
                <Link href="/signup">
                  <Button className="mt-5 w-36 bg-green-500 text-black hover:bg-green-600">
                    {isCurrentUser ? "Open Services" : "Sign up"}
                  </Button>
                </Link>
              </div>
            </section>
